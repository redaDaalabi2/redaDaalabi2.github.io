...
<section class="overflow-x-hidden bg-[#5AE4A8] relative z-10 py-[120px]">
    ...
    <div class="-mx-4 flex">
      <div class="w-full px-4">
        <div class="mx-auto max-w-[400px] text-center">
          ...
          <router-link
            to="/"
            class="cursor-pointer hover:text-green-600 inline-block rounded-lg border border-white px-8 py-3 text-center text-base font-semibold text-white transition hover:bg-white"
          >
            Go To Home
          </router-link>
        </div>
